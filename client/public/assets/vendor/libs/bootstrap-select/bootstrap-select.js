console.log("public select call");
!(function (e, t) {
              ...
              (K.prototype = {
                      ...
                      for (var g = 0; g < a && g < 50; g++) {
                        ...
                        b &&
                          ...
                          b.title
                            ...
                            : (s.options.showIcon && (w.icon = b.icon), s.options.showSubtext && !s.multiple && b.subtext && (w.subtext = " " + b.subtext), (w.text = b.text.trim())),
                ...
                setSize: function (t) {
                  if ((this.liHeight(t), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size)) {
                    ...
                    this.setMenuSize(),
                      ...
                      "auto" === this.options.size
                        ? s
                            .off("resize" + W + "." + this.selectId + ".setMenuSize scroll" + W + "." + this.selectId + ".setMenuSize")
                            .on("resize" + W + "." + this.selectId + ".setMenuSize scroll" + W + "." + this.selectId + ".setMenuSize", function () {
                              return i.setMenuSize();
                            })
                        : this.options.size &&
                          "auto" != this.options.size &&
                          this.selectpicker.current.elements.length > this.options.size &&
                          s.off("resize" + W + "." + this.selectId + ".setMenuSize scroll" + W + "." + this.selectId + ".setMenuSize");
                  }
                ...
                setDisabled: function (e) {
                  ...
                  s &&
                    ...
                    t && (M.major >= "4" && t.classList.toggle(B.DISABLED, i), i ? (t.setAttribute("aria-disabled", i), t.setAttribute("tabindex", -1)) : (t.removeAttribute("aria-disabled"), t.setAttribute("tabindex", 0))));
                },
                isDisabled: function () {
                          ...
                          for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                            ...
                            n[a] || (n[a] = k(c, s, l, r)),
                              n[a] &&
                                ...
                                (c.headerIndex > 0 && ((n[c.headerIndex - 1] = !0), o.push(c.headerIndex - 1)), (n[c.headerIndex] = !0), o.push(c.headerIndex), (n[c.lastIndex + 1] = !0)),
                ...
                keydown: function (t) {
                  ...
                  if (!(t.which >= 112 && t.which <= 123))
                    if (!(s = c.$menu.hasClass(B.SHOW)) && (u || (t.which >= 48 && t.which <= 57) || (t.which >= 96 && t.which <= 105) || (t.which >= 65 && t.which <= 90)) && (c.$button.trigger("click.bs.dropdown.data-api"), c.options.liveSearch))
                        ...
                        38 === t.which
                          ...
                          : (40 === t.which || p) &&
                            (i === c.selectpicker.view.firstHighlightIndex
                              ...
                              : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - c.sizeInfo.menuInnerHeight) > f)),
                      ...
                      s &&
                        ...
                        (c.options.liveSearch && 32 === t.which) || (c.$menuInner.find(".active a").trigger("click", !0), r.trigger("focus"), c.options.liveSearch || (t.preventDefault(), e(document).data("spaceSelect", !0))));
                    }
                },
                mobile: function () {
